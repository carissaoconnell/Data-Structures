...
// Binary Tree node with Circle object and pointers to left and right child
class TreeNode {
public:
    Circle* circle;
    TreeNode* left;
...
// Binary Tree class with insertion, search, traversal and deletion operations
class BinaryTree {
private:
    TreeNode* root;
...
void displayMenu(BinaryTree& binaryTree) {
int choice;
double radius;
