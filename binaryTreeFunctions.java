		...
		public class binaryTreeFunctions {
		    ...
		    public static void main(String[] args) {
		        ...
		        do {
		            ...
		            System.out.println("3. Display all Binary Tree Circle Objects (preorder traversal)");
		            System.out.println("4. Display all Binary Tree Circle Objects (inorder traversal)");
		            System.out.println("5. Display all Binary Tree Circle Objects (postorder traversal)");
		            ...
		            switch (choice) {
		            	// choice 1 - Add Circle Object to Binary Tree
		                case 1:
		                ...
		                // choice 2 - Search for Circle Object in Binary Tree
		                case 2:
		                ...
		                // choice 3 -Display all Binary Tree Circle Objects using preorder traversal
		                case 3:
		                    System.out.println("Binary Tree Circle Objects:");
		                    tree.displayPreorder(); // call displayPreorder method 
		                    break;
		                    
			             // choice 4 -Display all Binary Tree Circle Objects using inorder traversal
			             case 4:
			                 System.out.println("Binary Tree Circle Objects:");
			                 tree.displayInorder(); // call displayInorder method 
			                 break;
			                 
				          // choice 5 -Display all Binary Tree Circle Objects using postorder traversal
				          case 5:
				              System.out.println("Binary Tree Circle Objects:");
				              tree.displayPostorder(); // call displayPostorder method 
				              break;
		                   
				          // choice 6 - Delete a Node
				          case 6:
